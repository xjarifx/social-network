...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 w-full max-w-2xl translate-x-[-50%] translate-y-[-50%] rounded-3xl border border-border/60 bg-card/90 p-0 text-card-foreground shadow-glass backdrop-blur-xl data-[state=open]:animate-scale-in",
        className,
      )}
      {...props}
    >
